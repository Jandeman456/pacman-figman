...
The script was missing a closing bracket `]` for the `Pacman.WALLS` array and a closing semicolon `;` after the `clone` function definition. I've added these at the appropriate locations.